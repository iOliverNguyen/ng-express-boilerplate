module.exports = function(grunt) {
  ...
  var taskConfig = {
    ...
    dest_appview: 'src/server/appviews',
  ...
  grunt.registerTask('startserver', 'Start server.', ['express:dev:start']);
  grunt.registerTask('stopserver', 'Stop server.', ['express:dev:stop']);
